...
const mysteryTerms = [
    ['Springdale', 'Saint George', 'Boulder City', 'Searchlight', 'Anaheim', 'Henderson', 'Tijuana', 'Manchester', 'Saint Petersburg','Hong Kong','Fort Lauderdale','Virginia Beach','Boston','Las Vegas', 'London', 'Seattle', 'Salt Lake City', 'Mexico City', 'Mumbai', 'Rio De Janeiro', 'Buenos Aires', 'New York City'],
    ...
    ['Winnie the Pooh', 'Manchester by the Sea', 'Once Upon a Time In Hollywood', 'The Beauty and the Beast', 'Casablanca', 'The Grinch', 'Jingle All The Way', 'Its a Wonderful Life', 'Jurassic Park', 'Toy Story', 'The Shawshank Redemption', 'The Godfather', 'Raiders of the Lost Ark', 'The Dark Knight', 'Jaws', 'Pulp Fiction', 'Good Will Hunting', 'The Truman Show', 'Lawrence of Arabia', 'Snow White and the Seven Dwarfs', 'Forrest Gump', 'Stand By Me', 'Back to the Future', 'Shrek', 'Saving Private Ryan', 'No Country For Old Men', 'Titanic'],
    ['American Horror Stories', 'The Sopranos', 'Friday Night Lights', 'Orange Is the new Black', 'Lost', 'The Walking Dead', 'American Idol', 'The Golden Girls', 'Planet Earth', 'Breaking Bad', 'Game of Thrones', 'The Blue Planet', 'The Office', 'Black Mirror', 'Its Always Sunny In Philadelphia', 'Better Call Saul', 'Key and Peele', 'Peaky Blinders', 'Suits', 'Silicon Valley', 'Sons of Anarchy', 'Ozark'],
