...
const mysteryTerms = {
        ...
        movies: ['Jurassic World', 'Guardians of the Galaxy', 'Avatar', 'The Mummy', 'The Mummy Returns', 'Muppet Haunted Mansion', 'Winnie the Pooh', 'Manchester by the Sea', 'The Magnificent Seven', 'Gone With the Wind', 'Friday Night Lights', 'Remember the Titans', 'The Lion King', 'Frozen', 'Inside Out', 'Casablanca', 'The Grinch', 'The Addams Family', 'Lawless', 'Jingle All The Way', 'Jurassic Park', 'Toy Story', 'The Shawshank Redemption', 'Home Alone', 'Interstellar', 'The Godfather', 'The Wizard of Oz', 'Twister', 'Black Panther', 'West Side Story', 'Gladiator', 'The Wolf of Wall Street', 'Raiders of the Lost Ark', 'The Dark Knight', 'Jaws', 'Pinocchio', 'Pulp Fiction', 'Butch Cassidy and the Sundance Kid', 'Rocky', 'A Quiet Place', 'Ratatouille', 'Spotlight', 'Good Will Hunting', 'The Truman Show', 'La La Land', 'Lawrence of Arabia', 'Snow White and the Seven Dwarfs', 'Forrest Gump', 'Stand By Me', 'Back to the Future', 'Shrek', 'Zootopia', 'Saving Private Ryan', 'Titanic'],
