...
const gameContainer = document.querySelector('#hangman-game-container');
const difficultyBtn = document.querySelector('#difficulty-selector');
...
const mysteryTerms = {
        ...
        movies: ['Jurassic World', 'Guardians of the Galaxy', 'Avatar', 'The Mummy', 'The Mummy Returns', 'Winnie the Pooh', 'Manchester by the Sea', 'The Magnificent Seven', 'Friday Night Lights', 'Remember the Titans', 'The Lion King', 'Frozen', 'Inside Out', 'Casablanca', 'The Grinch', 'The Addams Family', 'Lawless', 'Jingle All The Way', 'Jurassic Park', 'Toy Story', 'The Shawshank Redemption', 'Home Alone', 'Interstellar', 'The Godfather', 'The Wizard of Oz', 'Twister', 'Black Panther', 'West Side Story', 'Gladiator', 'The Wolf of Wall Street', 'Raiders of the Lost Ark', 'The Dark Knight', 'Jaws', 'Pinocchio', 'Pulp Fiction', 'Butch Cassidy and the Sundance Kid', 'Rocky', 'A Quiet Place', 'Ratatouille', 'Spotlight', 'Good Will Hunting', 'The Truman Show', 'La La Land', 'Lawrence of Arabia', 'Snow White and the Seven Dwarfs', 'Forrest Gump', 'Back to the Future', 'Shrek', 'Zootopia', 'Saving Private Ryan', 'Titanic'],

        'tv shows': ['Mad Men', 'Seinfeld', 'The Simpsons', 'The West Wing', 'Friends', 'Parks and Recreation', 'Sex and the City', 'Designated Survivor', 'American Horror Stories', 'The Wire', 'The Sopranos', 'Friday Night Lights', 'Orange Is the new Black', 'The Walking Dead', 'American Idol', 'The Golden Girls', 'Planet Earth', 'Breaking Bad', 'Game of Thrones', 'The Blue Planet', 'The Office', 'Black Mirror', 'Better Call Saul', 'Peaky Blinders', 'Suits', 'Silicon Valley', 'Sons of Anarchy', 'Ozark'],
